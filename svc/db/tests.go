...
func (suite *CandlesticksSuite) TestCreate() {
	...
	t, _ := time.Parse(time.RFC3339, "1993-11-15T11:29:00Z")
...
// TODO(#14): Refactor this function to make it shorter
//
//nolint:funlen
func (suite *CandlesticksSuite) TestRead() {
	...
	t1, _ := time.Parse(time.RFC3339, "1993-11-15T11:29:00Z")
	suite.Require().NoError(list.Set(candlestick.Candlestick{
		Time:   t1,
		Open:   1,
		Low:    0.5,
	...
	t2, _ := time.Parse(time.RFC3339, "1993-11-15T11:30:00Z")
	suite.Require().NoError(list.Set(candlestick.Candlestick{
		Time:   t2,
		Open:   2,
		Low:    1,
	...
	t3, _ := time.Parse(time.RFC3339, "1993-11-15T11:31:00Z")
	suite.Require().NoError(list.Set(candlestick.Candlestick{
		Time:   t3,
		Open:   3,
		Low:    1.5,
	...
	t4, _ := time.Parse(time.RFC3339, "1993-11-15T11:32:00Z")
	suite.Require().NoError(list.Set(candlestick.Candlestick{
		Time:   t4,
		Open:   4,
		Low:    2,
...
// TODO(#15): Refactor this function to make it shorter
//
//nolint:funlen
