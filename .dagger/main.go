...
func (mod *Candlesticks) Generate(
	ctx context.Context,
	sourceDir *dagger.Directory,
) *dagger.Container {
...
func (mod *Candlesticks) Lint(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
...
func (mod *Candlesticks) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().From("golang:" + goVersion() + "-alpine")
	return mod.withGoCodeAndCacheAsWorkDirectory(c, sourceDir).
...
func (mod *Candlesticks) binanceIntegrationTests(
	sourceDir *dagger.Directory,
...
func (mod *Candlesticks) PublishContainer(
	ctx context.Context,
	sourceDir *dagger.Directory,
) error {
	// Create Git repo access
...
func (mod *Candlesticks) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
