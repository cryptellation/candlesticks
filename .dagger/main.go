// A generated module for Candlesticks functions
//
...
const (
	dockerImageName = "ghcr.io/cryptellation/candlesticks"
)

type Candlesticks struct{}

// Publish a new release.
func (ci *Candlesticks) PublishTag(
	ctx context.Context,
...
func (ci *Candlesticks) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().From("golang:" + goVersion() + "-alpine")
	return ci.withGoCodeAndCacheAsWorkDirectory(c, sourceDir).
...
func (ci *Candlesticks) dbIntegrationTests(sourceDir *dagger.Directory) *dagger.Container {
...
func (ci *Candlesticks) binanceIntegrationTests(
	sourceDir *dagger.Directory,
...
func (ci *Candlesticks) IntegrationTests(
	sourceDir *dagger.Directory,
...
func (ci *Candlesticks) EndToEndTests(
	sourceDir *dagger.Directory,
	binanceApiKey *dagger.Secret, //nolint:revive,stylecheck // var-naming: keep original name for CLI compatibility
	binanceSecretKey *dagger.Secret,
) *dagger.Container {
...
func (ci *Candlesticks) Container(
	sourceDir *dagger.Directory,
	// +optional
...
func (ci *Candlesticks) PublishContainer(
	ctx context.Context,
	sourceDir *dagger.Directory,
) error {
	// Create Git repo access
...
func (ci *Candlesticks) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
	containerPath := "/go/src/github.com/cryptellation/candlesticks"
	return c.
		// Add Go caches
